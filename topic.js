...
sunnah: {
    ...
    description: "রাসূলুল্লাহ ﷺ-এর জীবন, চরিত্র ও সুন্নাহ।",
    content: [
        {
...
ibadah: {
    title: "ইবাদত",
    description: "সালাত, সাওম, যাকাত, হজ, দুআ ও যিকর।",
    content: [
        {
            title: "সালাত",
...
"new-muslim": {
    title: "নও-মুসলিম",
    description: "ইসলাম গ্রহণের পর প্রয়োজনীয় প্রাথমিক জ্ঞান ও নির্দেশনা।",
    content: [
        {
...
if (filteredContent.length === 0) {
    ...
    contentElement.innerHTML =
        ...
        '<p>এই বিষয়ে এই ধরনের কনটেন্ট শীঘ্রই যোগ করা হবে।</p>' +
        '</article>';
